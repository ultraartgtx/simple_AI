...
public enum Transition
{
    NullTransition = 0,
    SawEnemy=1,
    LostEnemy=2,// Use this transition to represent a non-existing transition in your system
}
...
public enum StateID
{
    NullStateID = 0,
    ChasingEnemy=1,
    FollowingPath=2,// Use this ID to represent a non-existing State in your system	
}
...
public abstract class FSMState
{
    ...
    /// NPC is a reference to the object that is controlled by this class
    /// </summary>
    public abstract void Act(NavMeshAgent _agent,Vector3 position);
